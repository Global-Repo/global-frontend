...
import { Heading, Card, CardBody, CardFooter, Text, PancakeRoundIcon, Flex, Skeleton } from '@duhd4h/global-uikit'
...
const TotalPrizesCard = () => {
  ...
  const lotteryPrizeAmountBusd = new BigNumber(lotteryPrizeAmount).multipliedBy(globalPrice)
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              {globalPrice.gt(0) && <CardBusdValue value={lotteryPrizeAmountBusd.toNumber()} />}
            </PrizeCountWrapper>
          </Left>
          <Right>
