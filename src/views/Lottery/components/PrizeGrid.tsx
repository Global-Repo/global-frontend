...
const PrizeGrid: React.FC<PrizeGridProps> = ({
  ...
  const globalBusdPrice = usePriceGlobalBusd()

  const getCakeBusdValue = (amount: number) => {
    return new BigNumber(amount).multipliedBy(globalBusdPrice).toNumber()
  }
    ...
    <Grid pastDraw={pastDraw}>
      ...
      <GridItem>
        <RightAlignedHeading scale="md">
          ...
          {!pastDraw && globalBusdPrice.gt(0) && <CardBusdValue value={getCakeBusdValue(fourMatchesAmount)} />}
        </RightAlignedHeading>
      </GridItem>
      {/* 3 matches row */}
      <GridItem>
      ...
      <GridItem>
        <RightAlignedText>
          ...
          {!pastDraw && globalBusdPrice.gt(0) && <CardBusdValue value={getCakeBusdValue(threeMatchesAmount)} />}
        </RightAlignedText>
      </GridItem>
      {/* 2 matches row */}
      <GridItem>
      ...
      <GridItem>
        <RightAlignedText>
          ...
          {!pastDraw && globalBusdPrice.gt(0) && <CardBusdValue value={getCakeBusdValue(twoMatchesAmount)} />}
        </RightAlignedText>
      </GridItem>
      {/* Burn row */}
