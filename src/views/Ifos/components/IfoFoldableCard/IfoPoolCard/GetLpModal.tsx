...
import { Modal, ModalBody, Text, Image, Button, Link, OpenNewIcon } from '@duhd4h/global-uikit'
    ...
    <Modal title={t('LP Tokens required')} onDismiss={onDismiss}>
      <ModalBody maxWidth="288px">
        ...
        <Button
          as={Link}
          external
          href={`${BASE_ADD_LIQUIDITY_URL}/BNB/${process.env.REACT_APP_GLOBAL_ADDRESS}`}
