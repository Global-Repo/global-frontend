...
const useGetPresaleAmount = (tokenAddress: string) => {
  const { NOT_FETCHED, SUCCESS, FAILED } = FetchStatus
  const [balanceState, setBalanceState] = useState<UseGetPresaleAmountState>({
    balance: BIG_ZERO,
...
export default useGetPresaleAmount
